...
export default function DamageSimulator() {
  ...
  const runSimulation = () => {
    ...
    for (let i = 0; i < trials; i++) {
      const baseDmg = DAMAGE_FORMULA(attacker, defender);
      totalNormal += baseDmg;
      totalP += attacker.skills.P ? Math.floor(baseDmg * 1.5) : baseDmg;
      totalG1 += attacker.skills.G1 ? Math.floor(baseDmg * 2.0) : baseDmg;
      totalM1 += attacker.skills.M1 ? Math.floor(baseDmg * 2.5) : baseDmg;
    }
  ...
  return (
    <div className="w-full min-h-screen p-6 bg-gradient-to-br from-slate-900 to-slate-800 text-white">
      <div className="max-w-6xl mx-auto">
        ...
        <button
          ...
          className="w-full py-4 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 rounded-lg font-bold text-lg transition"
        >
